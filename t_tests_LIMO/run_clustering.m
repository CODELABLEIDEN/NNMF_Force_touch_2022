...
if tf
    time_range = 200;
%     time_range = 60;
    one_sample_reshaped = limo_tf_4d_reshape(one_sample, [64, 40, time_range,  5]);
    H0_one_sample_M_reshaped = limo_tf_4d_reshape(squeeze(H0_one_sample(:,:,1,:)), [64, 40, time_range, size(H0_one_sample,4)]);
    ...
    % P values under h0
    bootP = limo_tf_4d_reshape(squeeze(H0_one_sample(:,:,2,:)), [64, 40, time_range, size(H0_one_sample,4)]);
