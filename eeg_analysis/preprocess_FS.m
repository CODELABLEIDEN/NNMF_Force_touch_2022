function [filtered, base,start_indices,mid_indices,end_indices,n] = preprocess_FS(data)
...
[end_indices,start_indices,mid_indices,n_merged] = merge_fs(end_indices,start_indices,mid_indices);
[end_indices,start_indices,mid_indices,n_removed] = remove_short_ITIs(end_indices,start_indices,mid_indices);
n = n_merged+n_removed;
